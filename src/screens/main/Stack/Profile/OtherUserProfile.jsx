  ...
  const sportsPosts = [
    {
      ...
      ago: '1h ago',
      PostDescription:
        'Looking for 2 players to join our basketball match this evening in Brooklyn.',
      PostPicture: '',
    ...
    },
    {
      ...
      ago: '3h ago',
      PostDescription:
        'Volleyball team forming in LA for a weekend tournament. Need 4 players!',
    ...
    },
    {
      ...
      ago: '5h ago',
      PostDescription:
        'Pickup soccer game at Central Park. All skill levels welcome!',
      PostPicture: '',
    ...
    },
    {
      ...
      ago: '1d ago',
      PostDescription:
        'Looking for a few teammates for a co-ed softball game this Saturday.',
    ...
    },
    {
      ...
      ago: '4h ago',
      PostDescription:
        'Organizing a friendly flag football match. Need 3 more players.',
      PostPicture: '',
    ...
    },
    {
      ...
      ago: '30m ago',
      PostDescription:
        'Looking to create a 3v3 basketball team for a local league.',
      PostPicture: '',
      Likes: ['NatalieMorgan'],
    ...
    },
    {
      ...
      ago: '6h ago',
      PostDescription:
        'Anyone interested in a women’s soccer scrimmage this Sunday?',
    ...
    <View style={{ backgroundColor: AppColors.WHITE }}>
      ...
      >
        ...
        <LinearGradient
          ...
          start={{ x: 5, y: 0 }}
          style={{ height: responsiveHeight(100), padding: 20, paddingTop: 50 }}
        >
          ...
          <View>
            ...
            <AppText
              title={
                'Any sport, any time just Countme Kicking it every weekend'
              }
              textSize={2}
              textFontWeight
              textwidth={80}
            ...
            <View style={{ marginTop: 20 }}>
              <IconText
                Icon={<SvgIcons.us />}
                title="Lives In New York"
                textFontWeight
              />
              <IconText
                Icon={<SvgIcons.run />}
                title="Primary Sports: Cricket"
                textFontWeight
              />
              <IconText
                Icon={<SvgIcons.wifi />}
              ...
              <IconText
                Icon={<SvgIcons.clock />}
                title="Availability: Weekends"
                textFontWeight
              />
              <IconText
                Icon={<SvgIcons.arrow />}
                title="See About Your Info"
                textFontWeight
              />
            </View>
          </View>
